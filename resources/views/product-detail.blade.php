...
<div class="product_image_area mb-5">
    <div class="container">
        <div class="row s_product_inner">
            <div class="col-lg-6">
                <img class="img-fluid" src="{{ asset('img/product/'.$data->image) }}" alt="">
            </div>
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    <h3>{{ $data->name_product }}</h3>
                    <h2>Rp. {{ $data->unitprices[0]->unit_price }}</h2>
                    <p>{{ $data->description }}</p>
                    <form action="{{ route('order.create',$data->id) }}" method="post">
                        @csrf
                        @method('POST')
                        ...
                        <div class="card_area d-flex align-items-center">
                            <button class="btn primary-btn" type="submit">Checkout</button>
                        </div>
                    </form>
                </div>
            </div>
