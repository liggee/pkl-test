				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="img/product/{{ $item->image }}" alt="">
							<div class="product-details">
								<h6>{{ $item->name_product }}</h6>
								<div class="price">
									<h6>Rp. {{ $item->unitprices[0]->unit_price }} </h6>
									
								</div>
								<div class="prd-bottom">
									<a href="{{ route('order.detail',$item->id) }}" class="social-info">
										<span class="ti-bag"></span>
										<p class="hover-text">See Detail</p>
									</a>									
								</div>
							</div>
						</div>
